(() => {
  ...
  (r.m = e),
    ...
    (r.u = (e) =>
      288 === e
        ? "static/chunks/288-2a335754b591f98f.js"
        : "static/chunks/" +
          e +
          "." +
          {
            203: "215f7ebb412294c3",
            218: "ee5bb437b51df9be",
            365: "aae5f43bce8c2874",
          }[e] +
          ".js"),
    (r.miniCssF = (e) => {}),
    (r.g = (function () {
    ...
    (() => {
      ...
      r.l = (o, n, a, i) => {
        ...
        if (void 0 !== a)
          for (
            var u, l, s = document.getElementsByTagName("script"), c = 0;
            c < s.length;
            c++
          ) {
            var f = s[c];
    ...
    (r.p = "/viksitbharath/_next/"),
    (() => {
      var e = { 68: 0, 777: 0, 690: 0 };
      (r.f.j = (t, o) => {
        var n = r.o(e, t) ? e[t] : void 0;
        if (0 !== n) {
          if (n) o.push(n[2]);
          else if (/^(68|690|777)$/.test(t)) e[t] = 0;
          else {
